...
const commands = {
  ...
  skills:
    "My skills include React.js, Node.js, Express.js, MongoDB, and Tailwind CSS.",
  projects:
    "Some of my projects include a portfolio website, a task manager, and an e-commerce site.",
  ...
  return (
    <>
      <div className="flex flex-col w-full h-screen justify-center items-center">
        ...
        <h1 className="pb-4 font-arcade font-bold text-2xl text-secondary">
          The Terminal
        </h1>
        <p className="font-Code text-primary pb-2 opacity-60">
